...
The PodigeeEmbedKit maintainers takes security seriously.
If you discover a security issue, please bring it to our attention right away!

Please **DO NOT** file a public issue,
instead send your report privately to <hello@podigee.com>.
...
See [CODE_OF_CONDUCT.md](https://github.com/podigee/PodigeeEmbedKit/blob/master/CODE_OF_CONDUCT.md) for details.
